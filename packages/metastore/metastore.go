...
func (n Node) Attr() storage.Attr {
	return (storage.Attr{
		ID: uint64(n.ID), Kind: n.Kind, Size: n.Size, AccessTime: n.AccessTime, ModTime: n.ModTime, BirthTime: n.BirthTime, ChangeTime: n.ChangeTime, Metadata: n.Metadata,
	}).Clone()
}
...
// Clone owns variable payloads without interpreting their namespaces or tokens.
