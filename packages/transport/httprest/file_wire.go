...
const fileObserveDirectoryMetadata storage.Operation = "file-observe-directory-metadata"
const fileObserveName storage.Operation = "file-observe-name"
...
type fileRequest struct {
	DirectoryMetadata *storage.DirectoryMetadataOptions  `json:"directoryMetadata,omitempty"`
...
type fileResponse struct {
	...
	NameObservation *storage.NameObservation   `json:"nameObservation,omitempty"`
