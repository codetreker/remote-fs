...
// The registry lock never encloses a connection or session lock. Owners retain
// their server-wide capacity charge until native resources and local frames
// have completed cleanup, including after transport disconnection.
