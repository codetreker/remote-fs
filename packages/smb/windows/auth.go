// Package windows integrates the SMB endpoint with Windows security and the
// current user's SMB drive mappings. System changes are explicit Map/Unmount
// calls; importing this package and constructing an Authenticator have no side effects.
package windows
