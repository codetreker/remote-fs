...
type Limits struct {
	MaxConnections, MaxSessions, MaxTrees, MaxOpens                  int
...
func DefaultLimits() Limits {
	return Limits{MaxConnections: 16, MaxSessions: 16, MaxTrees: 32, MaxOpens: 1024,
...
func (l Limits) check() error {
	if l.MaxConnections < 1 || l.MaxSessions < 1 || l.MaxTrees < 1 || l.MaxOpens < 1 ||
...
// Status is bounded and contains no identities, paths, tokens or file contents.
type Status struct {
